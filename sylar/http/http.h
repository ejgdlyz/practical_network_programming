...
public:
    ...
    void setHeader(const std::string& key, const std::string& val);  // 从 Headers 取数据
...
private:
    ...
    MapType m_cookies;          // 请求 Cookies map
};
